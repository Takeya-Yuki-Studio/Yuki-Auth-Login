...
CREATE TABLE `acctokens` (
  ...
  COMMENT 'Token ID',
  `app`            INT NOT NULL
  COMMENT 'App Connect ID',
  `uid`            INT NOT NULL
  COMMENT 'App Connect User',
  `token`          VARCHAR(32) BINARY
                   COLLATE 'utf8_bin' COMMENT 'Access Token',
  `refresh`        VARCHAR(32) BINARY
                   COLLATE 'utf8_bin' COMMENT 'Refresh Token',
